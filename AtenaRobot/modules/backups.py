...
import AtenaRobot.modules.sql.notes_sql as sql
from AtenaRobot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from AtenaRobot.__main__ import DATA_IMPORT
from AtenaRobot.modules.helper_funcs.chat_status import user_admin
from AtenaRobot.modules.helper_funcs.alternate import typing_action

# from AtenaRobot.modules.rules import get_rules
import AtenaRobot.modules.sql.rules_sql as rulessql

# from AtenaRobot.modules.sql import warns_sql as warnssql
import AtenaRobot.modules.sql.blacklist_sql as blacklistsql
from AtenaRobot.modules.sql import disable_sql as disabledsql

# from AtenaRobot.modules.sql import cust_filters_sql as filtersql
# import AtenaRobot.modules.sql.welcome_sql as welcsql
import AtenaRobot.modules.sql.locks_sql as locksql
from AtenaRobot.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("AtenaRobot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("AtenaRobot{}.backup".format(chat_id), "rb"),
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `AtenaRobot-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("AtenaRobot{}.backup".format(chat_id))  # Cleaning file
