...
from AtenaRobot import MONGO_DB_URI
from AtenaRobot import telethn
...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        import importlib
        import AtenaRobot.events

        path = Path(f"AtenaRobot/modules/{shortname}.py")
        name = "AtenaRobot.modules.{}".format(shortname)
        ...
        mod.AtenaRobot = AtenaRobot
        mod.tbot = telethn
        mod.logger = logging.getLogger(shortname)
        spec.loader.exec_module(mod)
        sys.modules["AtenaRobot.modules." + shortname] = mod
        print("Successfully imported " + shortname)


path = "AtenaRobot/modules/*.py"
